...
fn main() {
    ...
    let current_accumulator_hash =
        BachedAccumulator::<Bn256, Bn256CeremonyParameters>::calculate_hash(
    ...
    let response_hash =
        BachedAccumulator::<Bn256, Bn256CeremonyParameters>::calculate_hash(&response_readable_map);
    ...
    if COMPRESS_NEW_CHALLENGE == UseCompression::Yes {
        ...
        let recompressed_hash = BachedAccumulator::<Bn256, Bn256CeremonyParameters>::calculate_hash(
